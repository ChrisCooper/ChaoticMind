...
namespace ChaoticMind {
    class MapTileUtilities {
        ...
        private static void loadOverlays() {
            ...
            _OverlaySprites.Add(new StaticSprite("TileAppearance/TileOverlay_Triple", MapTile.TileSideLength, DrawLayers.GameElements.TileOverlay));
            _OverlaySprites.Add(new StaticSprite("TileAppearance/TileOverlay_Straight", MapTile.TileSideLength, DrawLayers.GameElements.TileOverlay));
            _OverlaySprites.Add(new StaticSprite("TileAppearance/TileOverlay_Bent", MapTile.TileSideLength, DrawLayers.GameElements.TileOverlay));
            _OverlaySprites.Add(new StaticSprite("TileAppearance/TileOverlay_Single", MapTile.TileSideLength, DrawLayers.GameElements.TileOverlay));
        }

        //load the overlay textures
        private static void loadMapSprites() {
            _MapSprites = new List<StaticSprite>(4);
            _MapSprites.Add(new StaticSprite("Minimap/TileMap_Triple", MapTile.TileSideLength, DrawLayers.HUD.Minimap_Maze));
            _MapSprites.Add(new StaticSprite("Minimap/TileMap_Straight", MapTile.TileSideLength, DrawLayers.HUD.Minimap_Maze));
            _MapSprites.Add(new StaticSprite("Minimap/TileMap_Bent", MapTile.TileSideLength, DrawLayers.HUD.Minimap_Maze));
            _MapSprites.Add(new StaticSprite("Minimap/TileMap_Hidden", MapTile.TileSideLength, DrawLayers.HUD.Minimap_Maze));
        }

        //load the shift interface textures
        private static void loadShiftSprites() {
            _ShiftSprites = new List<StaticSprite>(4);
            _ShiftSprites.Add(new StaticSprite("Shifting/TileShift_Triple", MapTile.TileSideLength, DrawLayers.Menu.Elements));
            _ShiftSprites.Add(new StaticSprite("Shifting/TileShift_Straight", MapTile.TileSideLength, DrawLayers.Menu.Elements));
            _ShiftSprites.Add(new StaticSprite("Shifting/TileShift_Bent", MapTile.TileSideLength, DrawLayers.Menu.Elements));
            _ShiftSprites.Add(new StaticSprite("Shifting/TileShift_Hidden", MapTile.TileSideLength, DrawLayers.Menu.Elements));
        }
